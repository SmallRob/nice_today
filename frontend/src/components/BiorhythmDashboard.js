    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">正在检测后端服务连接...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">生物节律生活助手</h1>
                <p className="text-sm text-gray-600">基于科学计算的个性化生活建议</p>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-4">
          <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded-lg shadow-sm">
            <div className="flex items-start">
              ...
              <div className="ml-3">
                <h3 className="text-sm font-medium text-yellow-800">后端服务未连接</h3>
                ...
                <div className="mt-3">
                  <button
                    ...
                    className="bg-yellow-100 border border-yellow-300 rounded-md px-3 py-1 text-sm font-medium text-yellow-800 hover:bg-yellow-200 transition-colors"
                  >
                    重新检测连接
                  </button>
                </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-lg shadow-sm border p-6">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">生物节律分析</h3>
          ...
          <div className="bg-white rounded-lg shadow-sm border p-6">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">玛雅日历</h3>
            <p className="text-gray-600 text-sm">
          ...
          <div className="bg-white rounded-lg shadow-sm border p-6">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">穿衣饮食指南</h3>
            <p className="text-gray-600 text-sm">
              结合传统五行理论和现代健康理念，
          ...
          <div className="bg-white rounded-lg shadow-sm border p-6">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">生活建议报告</h3>
            <p className="text-gray-600 text-sm">
              综合生物节律、天气状况和个人偏好，
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-4 mt-4 md:mt-0">
              <span className="text-gray-500 text-sm">版本: v2.1</span>
              <span className="text-gray-500 text-sm">最后修改: 2025-11-12</span>
            </div>
          </div>
        </div>
      </footer>
