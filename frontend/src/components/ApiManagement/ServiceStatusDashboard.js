...
const ServiceStatusDashboard = () => {
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-2xl font-bold mb-6">服务状态监控</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className={`text-lg font-medium ${status.status === 'running' ? 'text-green-600' : 'text-red-600'}`}>
          ...
          <div>
            ...
            <p className="text-lg font-medium">{formatTime(status.timestamp)}</p>
          </div>
        </div>
      </div>
      ...
      {status.resources && (
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          <h2 className="text-xl font-semibold mb-4">资源使用情况</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* CPU使用率 */}
            <div>
              <h3 className="text-lg font-medium mb-3 text-gray-800">CPU</h3>
              ...
              <p className="mt-2 text-lg font-medium">{status.resources.cpu_percent.toFixed(2)}%</p>
            </div>
            
            {/* 内存使用率 */}
            <div>
              <h3 className="text-lg font-medium mb-3 text-gray-800">内存</h3>
              <div className="w-full bg-gray-200 rounded-full h-2.5">
                <div 
              ...
              <p className="mt-2 text-lg font-medium">{status.resources.memory_percent.toFixed(2)}%</p>
            ...
            {/* 磁盘使用率 */}
            <div>
              <h3 className="text-lg font-medium mb-3 text-gray-800">磁盘</h3>
              <div className="w-full bg-gray-200 rounded-full h-2.5">
                <div 
              ...
              <p className="mt-2 text-lg font-medium">{status.resources.disk_percent.toFixed(2)}%</p>
              <p className="text-sm text-gray-600 mt-1">
      ...
      {status.services && (
        <div className="bg-white rounded-lg shadow-md p-6">
          <h2 className="text-xl font-semibold mb-4">服务详情</h2>
              ...
              <div key={serviceName} className="border border-gray-200 rounded-lg p-4">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className={`text-sm ${isRunning ? 'text-green-600' : 'text-red-600'}`}>
                      {isRunning ? '运行中' : '停止'}
                    </p>
                  </div>
                </div>
